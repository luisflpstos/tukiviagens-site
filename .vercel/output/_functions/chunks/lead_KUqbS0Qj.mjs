...
function getLeadWebhookUrl() {
	return process.env.LEAD_WEBHOOK_URL ?? "https://flow-webhook-prd.kortex.app.br/webhook/olimtour/campanhas";
}
function getLeadWebhookSecret() {
	return process.env.LEAD_WEBHOOK_SECRET ?? "d11bddcb337963161e5d40ede1742";
}
//#endregion
